...
<%
    ...
    Response.Write("Id: " & ID_Nguoi_dung & "<br>")
    ...
    strSQL = "INSERT INTO truyen (ten_truyen,id_the_loai, so_chuong, nam_xb, anh_truyen, tinh_trang, mo_ta_ndung, id_nguoi_dung) VALUES ('" & TenTruyen & "','" & TheLoai & "', '" & SoChuong & "', '" & NamXuatBan & "', '" & AnhTruyen & "', '" & TinhTrang & "', '" & MoTa & "','" & ID_Nguoi_dung & "' )"
