                    ...
                    <div class="card-body">
                        <form id="myForm" method="post" action="/check/checkupdateinfo.asp">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" value="Sửa thông tin">Sửa</button>
                                <a type="button" class="btn btn-default float-right" href="info.asp?id_nguoi_dung=<%= rs("id_nguoi_dung") %>">Hủy bỏ</a>
                            </div>
                        </form>
                    </div>   
                    <%
