            ...
            <table class="table table-striped">
                                ...
                                <tbody>                               
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a type="button" href="admin_huy_duyet_chuong.asp?id_truyen=<%=Result("id_truyen")%>&id_nguoi_dung=<%= id_nguoi_dung%>&page=<%= page %>&id_chuong=<%=Result("id_chuong")%>" class="btn btn-danger">Xóa</a>
                                    </td> 
                                    </tr>
                                </tbody>
                                <%
