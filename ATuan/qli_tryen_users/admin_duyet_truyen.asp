    ...
    <div class="noidung">
        ...
        <div class="content">
            <%
                ...
                Dim strSQL
                If vai_tro = 1 Then
                    strSQL = "SELECT * FROM truyen where duyet = 0"
            ...
            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <td class="text-center">
                                        <a type="button" href="admin_duyet_chuong.asp?id_truyen=<%=Result("id_truyen")%>&id_nguoi_dung=<%= id_nguoi_dung%>" class="btn btn-primary" >Xem chương</a>
                                    </td>
                                    <td class="text-center">
                                        <a type="button" href="admin_duyet_truyen_base.asp?id_truyen=<%=Result("id_truyen")%>&id_nguoi_dung=<%= id_nguoi_dung%>&page=<%= page %>" class="btn btn-primary"> Duyệt</a>
                                        <a type="button" href="admin_huy_duyet_truyen.asp?id_truyen=<%=Result("id_truyen")%>&id_nguoi_dung=<%= id_nguoi_dung%>&page=<%= page %>" class="btn btn-danger">Xóa</a>
                                    </td> 
                                    </tr>
                                </tbody>
                                <%
