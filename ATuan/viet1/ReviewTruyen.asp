    ...
    <div class="context">
        ...
        <div id= "ndungReview">
            <%
                ...
                rs.Open "SELECT * FROM truyen WHERE id_the_loai = " & id_the_loai, conn
            ...
            <li class="list-group-item">
                <div>
                    <h4><%= rs("ten_truyen") %></h4>
                    <% 
                            ' Truy vấn lấy thông tin người dùng từ bảng nguoi_dung
                            Dim rsNguoiDung
                        ...
                        %>
                        <% 
                            ' Định dạng lại năm xuất bản
                            Dim nam_xb
                            nam_xb = rs("nam_xb")
                            If Not IsNull(nam_xb) Then
                                Dim formattedNamXB
                                formattedNamXB = FormatDateTime(nam_xb, 2) ' 2: dd/mm/yy
                                %>
